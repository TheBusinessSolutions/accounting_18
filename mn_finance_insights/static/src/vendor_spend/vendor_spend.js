...
export class VendorSpend extends Component {
    static template = "mn_finance_insights.VendorSpend";
    static props = { "*": true };
    setup() {
    ...
    async load() {
        ...
        try { this.state.data = await this.orm.call("finance.vendor.spend", "get_vendor_data", [this.state.options]); }
...
registry.category("actions").add("mn_finance_insights.vendor_spend", VendorSpend);
