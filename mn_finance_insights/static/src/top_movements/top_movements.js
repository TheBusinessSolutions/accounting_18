...
export class TopMovements extends Component {
    static template = "mn_finance_insights.TopMovements";
    static props = { "*": true };
    setup() {
    ...
    async load() {
        ...
        try { this.state.data = await this.orm.call("finance.top.movements", "get_movements_data", [this.state.options]); }
...
registry.category("actions").add("mn_finance_insights.top_movements", TopMovements);
