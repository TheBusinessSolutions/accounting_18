...
export class TopDiscounts extends Component {
    static template = "mn_finance_insights.TopDiscounts";
    static props = { "*": true };
    setup() {
    ...
    async load() {
        ...
        try { this.state.data = await this.orm.call("finance.top.discounts", "get_discount_data", [this.state.options]); }
...
registry.category("actions").add("mn_finance_insights.top_discounts", TopDiscounts);
