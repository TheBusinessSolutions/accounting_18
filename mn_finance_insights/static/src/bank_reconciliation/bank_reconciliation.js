...
export class BankReconciliation extends Component {
    static template = "mn_finance_insights.BankReconciliation";
    static props = { "*": true };
    setup() {
    ...
    async load() {
        ...
        try { this.state.data = await this.orm.call("finance.bank.reconciliation", "get_rec_data", [this.state.options]); }
...
registry.category("actions").add("mn_finance_insights.bank_reconciliation", BankReconciliation);
