...
export class AnalyticPL extends Component {
    static template = "mn_finance_insights.AnalyticPL";
    static props = { "*": true };
    setup() {
    ...
    async load() {
        ...
        try { this.state.data = await this.orm.call("finance.analytic.pl", "get_analytic_data", [this.state.options]); }
...
registry.category("actions").add("mn_finance_insights.analytic_pl", AnalyticPL);
