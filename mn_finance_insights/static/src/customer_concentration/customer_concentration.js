...
export class CustomerConcentration extends Component {
    static template = "mn_finance_insights.CustomerConcentration";
    static props = { "*": true };
    setup() {
    ...
    async load() {
        ...
        try { this.state.data = await this.orm.call("finance.customer.concentration", "get_concentration_data", [this.state.options]); }
...
registry.category("actions").add("mn_finance_insights.customer_concentration", CustomerConcentration);
