...
export class FreeCashFlow extends Component {
    static template = "mn_finance_insights.FreeCashFlow";
    static props = { "*": true };
    setup() {
    ...
    async load() {
        ...
        try { this.state.data = await this.orm.call("finance.free.cash.flow", "get_fcf_data", [this.state.options]); }
...
registry.category("actions").add("mn_finance_insights.free_cash_flow", FreeCashFlow);
