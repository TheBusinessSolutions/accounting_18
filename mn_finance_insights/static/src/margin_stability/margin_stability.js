...
export class MarginStability extends Component {
    static template = "mn_finance_insights.MarginStability";
    static props = { "*": true };
    setup() {
    ...
    async load() {
        ...
        try { this.state.data = await this.orm.call("finance.margin.stability", "get_stability_data", [this.state.options]); }
...
registry.category("actions").add("mn_finance_insights.margin_stability", MarginStability);
