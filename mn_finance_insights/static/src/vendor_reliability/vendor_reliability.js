...
export class VendorReliability extends Component {
    static template = "mn_finance_insights.VendorReliability";
    static props = { "*": true };
    setup() {
    ...
    async load() {
        ...
        try { this.state.data = await this.orm.call("finance.vendor.reliability", "get_reliability_data", [this.state.options]); }
...
registry.category("actions").add("mn_finance_insights.vendor_reliability", VendorReliability);
