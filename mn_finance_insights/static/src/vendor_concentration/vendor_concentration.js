...
export class VendorConcentration extends Component {
    static template = "mn_finance_insights.VendorConcentration";
    static props = { "*": true };
    setup() {
    ...
    async load() {
        ...
        try { this.state.data = await this.orm.call("finance.vendor.concentration", "get_concentration_data", [this.state.options]); }
...
registry.category("actions").add("mn_finance_insights.vendor_concentration", VendorConcentration);
